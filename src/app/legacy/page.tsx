...
export default function Home() {
  return (
    <main id="main-content" tabIndex={-1} className="min-h-screen bg-background flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-border">
      ...
      {/* RENTAL */}
      <Link href="/ivyjstudio/catalog" className="flex-1 group relative flex items-center justify-center min-h-[33vh] md:min-h-screen hover:bg-muted/50 transition-colors duration-500">
      ...
      {/* WHOLESALE */}
      <Link href="/ivyjstudio/wholesale" className="flex-1 group relative flex items-center justify-center min-h-[33vh] md:min-h-screen hover:bg-muted/50 transition-colors duration-500">
        <div className="text-center z-10 p-8">
